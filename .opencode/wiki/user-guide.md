...
3. [Конфигурация opencode.json](#3-конфигурация-opencodejson)
4. [Ежедневное использование](#4-ежедневное-использование)
5. [Миссии и команда /task](#5-миссии-и-команда-task)
6. [Где хранятся скилы и wiki](#6-где-хранятся-скилы-и-wiki)
7. [Оркестратор и GitHub](#7-оркестратор-и-github)
8. [База данных project.db](#8-база-данных-projectdb)
9. [MCP-серверы](#9-mcp-серверы)
10. [Дашборд](#10-дашборд)
11. [Отслеживание промпта в миссии](#11-отслеживание-промпта-в-миссии)
